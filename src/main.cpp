...
int main() {
    ...
    auto pieces = sh
        | std::views::transform([](Shape<8>::shape_t sh){
              return Piece<L>{ Shape<L>{ Shape<8>{ sh } } };
          })
        | std::ranges::to<std::vector>();
    Shape<8> b0{ 0b11111100'11111100'11111110'11111110'11111110'11111110'11100000ull };
    Shape<L> board{ b0.transform<false, true, true>(true) };
